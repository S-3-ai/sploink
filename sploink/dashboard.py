...
<footer>
  Generated by <code>python -m sploink.dashboard</code> · Refresh after each bench run · No external dependencies
</footer>
...
if (DATA.savings) {
  ...
  heroEl.innerHTML = `
    <div class="hero">
      <div class="big-number">${Object.keys(DATA.aggregates).length}</div>
      <div class="label">strategies measured</div>
      <div class="detail">Add both <b>lpu_only</b> and <b>hw_routed</b> runs to compute the savings headline.</div>
    </div>`;
}
